...
def draw_top_gamers():
    font_top = pygame.font.SysFont("arial", 30)
    font_gamer = pygame.font.SysFont("arial", 22)
...
def draw_interface(score, delta=0):
    ...
    font_delta = pygame.font.SysFont("arial", 24)
...
def draw_intro():
    #font_logo = pygame.font.SysFont("arial", 30)
    #text_game = font_logo.render("game", True, COLOR_TEXT)
    font = pygame.font.SysFont("arial", 50)
    ...
    while not is_find_name:
        ...
        screen.blit(pygame.transform.scale(imglogo, [490, 600]), [0, 0])
        #screen.blit(text_game, (260, 480))
...
def draw_game_over():
    ...
    imglogo = pygame.image.load("logo.png")
    text_game_over = font_score.render("Game Over", True, BLACK)
    text_score = font_score.render(f"Вы набрали {score}", True, BLACK)
    best_score = GAMERS_DB[0][1]
    if score > best_score:
        text = "Новый рекорд!"
    else:
        text = f"Рекорд {best_score}"
    text_record = font_score.render(text, True, BLACK)
    ...
    while not make_decision:
        ...
        screen.fill(BLACK)
        screen.blit(pygame.transform.scale(imglogo, [490, 600]), [0, 0])
        screen.blit(text_game_over, (30, 130))
        screen.blit(text_score, (30, 180))
        screen.blit(text_record, (30, 230))
        pygame.display.update()
    screen.fill(BLACK)
